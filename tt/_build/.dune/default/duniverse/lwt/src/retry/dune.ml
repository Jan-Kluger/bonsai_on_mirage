...
module V1 = struct
  let context = "default"
        ...
        let ocamlc_config = [ "version"                   , "4.14.2"
      ; "standard_library_default"  , "/Users/yannick/.opam/goblint-4.14/lib/ocaml"
      ; "standard_library"          , "/Users/yannick/.opam/goblint-4.14/lib/ocaml"
      ...
      ; "host"                      , "aarch64-apple-darwin25.1.0"
      ; "target"                    , "aarch64-apple-darwin25.1.0"
      ; "profiling"                 , "false"
      ; "flambda"                   , "false"
      ; "spacetime"                 , "false"
      ; "safe_string"               , "true"
